...
export const DEFAULT_COMPONENT_REGISTRY = {
  ...
  "ui.form.modal": {
    js: "./ui.form.modal.js?v=0.21.190",
    css: [UI_TOKENS_CSS, UI_COMPONENTS_CSS, "../../css/ui/ui.modal.css", "../../css/ui/ui.form.modal.css?v=0.21.190", "../../css/ui/ui.number.stepper.css", "../../css/ui/ui.select.css", "../../css/ui/ui.tree.select.css", "../../css/ui/ui.password.css", "../../css/ui/ui.toggle.css"],
  ...
  "ui.select": {
    js: `./ui.select.js?v=${UI_SELECT_REV}`,
    css: [UI_TOKENS_CSS, UI_COMPONENTS_CSS, `../../css/ui/ui.select.css?v=${UI_SELECT_REV}`],
    deps: [],
    export: "createSelect",
  },
  "ui.tree.select": {
  ...
  "ui.popover": {
    js: `./ui.popover.js?v=${UI_POPOVER_REV}`,
    css: [UI_TOKENS_CSS, UI_COMPONENTS_CSS, `../../css/ui/ui.popover.css?v=${UI_POPOVER_REV}`],
    deps: [],
