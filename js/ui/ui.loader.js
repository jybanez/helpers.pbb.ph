...
const UI_OVERLAY_ROUTING_REV = "0.21.113";
...
export const DEFAULT_COMPONENT_REGISTRY = {
  ...
  "ui.pdf.viewer": {
    js: "./ui.pdf.viewer.js",
    css: [UI_TOKENS_CSS, UI_COMPONENTS_CSS, "../../css/ui/ui.pdf.viewer.css"],
    deps: [],
