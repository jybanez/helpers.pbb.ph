...
- Fixed remaining media/modal accessibility regressions by preserving explicit decorative image `alt: ""` values in `ui.media.viewer` and making `.ui-modal-header` non-landmark chrome to avoid duplicate banner landmarks inside app shells.
